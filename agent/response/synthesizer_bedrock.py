...
def _build_prompt(
    *,
    ...
    return (
        ...
        "All output prose must be in highly professional, polished business English, regardless of the user's prompt language.\n"
        ...
        "asking user to choose risk appetite (low/medium/high) and keep guidance provisional.\n"
        ...
        "JSON example:\n"
        "{\"schema_version\":\"answer_plan_v2\",\"language\":\"en\","
        "\"summary_lines\":[\"Net cashflow is [F:spend.net_cashflow.30d]\",\"...\",\"...\"],"
        "\"key_metrics\":[{\"fact_id\":\"spend.net_cashflow.30d\",\"label\":\"Net Cashflow\"}],"
        "\"actions\":[\"First, stabilize cashflow around [F:spend.net_cashflow.30d]\",\"...\"],"
